...
export default function App() {
  ...
  const [clients, setClients] = useState<string[]>([
    "Crowdstrike", "Palo Alto Networks", "Microsoft", "Orca", "Mitiga", "Wiz", "Cyera",
    "Teleskope", "Neural Trust", "Cyata", "Okta", "Neon Security", "ConductorOne",
    "Imper AI", "Silverfort", "Opti", "1Password", "Orchid", "Aizome", "Apono",
    "Teleport", "Swimlane", "Panther", "Cribl", "Vega", "Brava Security", "AI Strike",
    "Anomali", "Acalvio", "Abnormal AI", "Cimento", "Netskope", "Stifel", "Surf AI",
    "ClearVector", "Bloom Security"
  ]);
  const [watchlist, setWatchlist] = useState<string[]>([
    ...
    "Apex Security", "Grip Security", "Descope", "Acuvity AI", "Keycard",
    "Aikido Security", "Venn"
  ]);
